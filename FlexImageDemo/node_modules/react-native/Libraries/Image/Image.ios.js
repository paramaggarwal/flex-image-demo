...
var Image = React.createClass({
  propTypes: {
     ...
     * 
     * For remote network images, the intrinsic width and height of the remote 
     * image is passed in here, to be able to resize the height of the image 
     * correctly in proportion to the width when using flex layout. For static
     * images, these dimensions are set automatically by the packager.
     */
