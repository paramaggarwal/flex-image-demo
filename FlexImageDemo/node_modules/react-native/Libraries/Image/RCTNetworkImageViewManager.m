...
{
  RCTImageShadowView *shadowView = [[RCTImageShadowView alloc] init];  
  return shadowView;
}
...
RCT_EXPORT_SHADOW_PROPERTY(intrinsicWidth, CGFloat)
RCT_EXPORT_SHADOW_PROPERTY(intrinsicHeight, CGFloat)
